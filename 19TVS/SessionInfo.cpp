...
int GetSessionInfo(HWND hWnd_1)
{
	...
	// #### WARNING ####
	// В SLT.IFS можно через запятую указывать состояния, которые предшествуют текущему. 
	// Тогда в моменте будет осуществляться перегрузка 
	// То есть запись 85,1,84 означает, что что-то будет браться из 84 состояния
